...
# 표준 모듈들을 별도로 설치하지 않고 import 후 바로사용
...
print(random.randrange(1, 10))  # 1 이상 10 미만의 정수
...
print()
print(random.random())  # 2668994992837386
...
# 6) shuffle() 함수
# 전달된 시퀀스 자료형에 속한 요소의 순서를 임의로 조정하여 다시 재배치 하는 함수
